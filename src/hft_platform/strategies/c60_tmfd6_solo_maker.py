...
class C60TmfD6SoloMakerMinimal(BaseStrategy):
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        self._qi_skew_threshold: float = _as_float(kwargs.get("qi_skew_threshold", 0.10), 0.10)
        self._qi_skew_widen_ticks: int = _as_int(kwargs.get("qi_skew_widen_ticks", 1), 1)
        self._enable_qi_layer: bool = bool(kwargs.get("enable_qi_layer", True))
