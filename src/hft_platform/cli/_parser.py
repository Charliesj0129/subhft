...
def build_parser() -> argparse.ArgumentParser:
    ...
    build.add_argument("--max-subscriptions", type=int, default=480, help="Subscription limit (4 conn × 120 codes; each code = 2 broker topics)")
    ...
    preview.add_argument("--max-subscriptions", type=int, default=480, help="Subscription limit (4 conn × 120 codes; each code = 2 broker topics)")
    ...
    validate.add_argument("--max-subscriptions", type=int, default=480, help="Subscription limit (4 conn × 120 codes; each code = 2 broker topics)")
    ...
    sync.add_argument("--max-subscriptions", type=int, default=480, help="Subscription limit (4 conn × 120 codes; each code = 2 broker topics)")
