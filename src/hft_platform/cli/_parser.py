...
def build_parser() -> argparse.ArgumentParser:
    ...
    build.add_argument("--max-subscriptions", type=int, default=800, help="Subscription limit (4 conn × 200)")
    ...
    preview.add_argument("--max-subscriptions", type=int, default=800, help="Subscription limit (4 conn × 200)")
    ...
    validate.add_argument("--max-subscriptions", type=int, default=800, help="Subscription limit (4 conn × 200)")
    ...
    sync.add_argument("--max-subscriptions", type=int, default=800, help="Subscription limit (4 conn × 200)")
