...
# ---------------------------------------------------------------------------
_DEFAULT_CHECK_INTERVAL_S = float(os.environ.get("HFT_RECON_CHECK_INTERVAL", "5"))  # precision-ok: timing
_DEFAULT_GRACE_FAILURES = int(os.environ.get("HFT_RECON_GRACE_FAILURES", "10"))
_DEFAULT_BACKOFF_BASE = float(os.environ.get("HFT_RECON_BACKOFF_BASE", "2"))  # precision-ok: timing
_DEFAULT_BACKOFF_MAX = float(os.environ.get("HFT_RECON_BACKOFF_MAX", "60"))  # precision-ok: timing
_BACKOFF_JITTER = 0.2
...
class ReconciliationService:
    ...
    def _record_sync_duration(self, duration_s: float) -> None:  # precision-ok: timing
