...
from hft_platform.contracts.strategy import OrderIntent, StormGuardState, IntentType
...
class PriceBandValidator(RiskValidator):
    def check(self, intent: OrderIntent) -> Tuple[bool, str]:
        ...
        # De-scale intent.price (Fixed Point x10000)
        price_float = intent.price / 10000.0
...
class MaxNotionalValidator(RiskValidator):
    def check(self, intent: OrderIntent) -> Tuple[bool, str]:
        ...
        notional = (intent.price / 10000.0) * intent.qty
