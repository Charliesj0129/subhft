...
class RiskThresholds:
    ...
    feed_gap_storm_s: float = 1.0  # precision-time
...
class StormGuard:
    ...
    def reload_thresholds(self, config: dict) -> None:
        ...
        elif "feed_gap_halt_s" in risk_cfg:
            self.thresholds.feed_gap_storm_s = float(risk_cfg["feed_gap_halt_s"])  # precision-ok (legacy key)
        self._apply_env_overrides()
