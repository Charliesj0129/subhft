...
class StrategyRunner:
    __slots__ = (
        "bus", "risk_queue", "lob_engine", "feature_engine", "position_store",
        "registry", "strategies", "_strat_executors", "_risk_submit", "_risk_submit_typed",
        "_typed_intent_fastpath", "_lob_snapshot_source", "_lob_l1_source",
        "_feature_value_source", "_feature_view_source", "_feature_set_source",
        "_feature_profile_source", "_feature_tuple_source",
        "metrics", "latency", "_trace_sampler", "_obs_policy", "_diagnostic_metrics_enabled",
        "symbol_metadata", "price_codec", "_intent_seq",
        "_positions_cache", "_positions_dirty", "_current_source_ts_ns", "_current_trace_id",
        "_strategy_metrics_sample_every", "_strategy_metrics_batch",
        "_strategy_metrics_seq", "_strategy_pending_intents",
        "_strategy_pending_alpha_intent", "_strategy_pending_alpha_flat",
        "_circuit_threshold", "_circuit_recovery_threshold", "_circuit_cooldown_ns",
        "_failure_counts", "_circuit_states", "_circuit_success_counts", "_circuit_halted_at_ns",
        "_rust_circuit", "_position_key_cache", "_strat_index",
