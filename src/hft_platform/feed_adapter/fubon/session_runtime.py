...
_ENV_PASSWORD = "FUBON_PASSWORD"
_ENV_API_KEY = "FUBON_API_KEY"
_ENV_CERT_PATH = "FUBON_CERT_PATH"
_ENV_CERT_PASS = "FUBON_CERT_PASS"
...
class FubonSessionRuntime:
    ...
    def __init__(self, config: dict[str, Any] | None = None) -> None:
        ...
        self._password: str = str(cfg.get("password") or os.getenv(_ENV_PASSWORD, ""))
        self._api_key: str = str(cfg.get("api_key") or os.getenv(_ENV_API_KEY, ""))
        self._cert_path: str = str(cfg.get("cert_path") or os.getenv(_ENV_CERT_PATH, ""))
        self._cert_pass: str = str(cfg.get("cert_pass") or os.getenv(_ENV_CERT_PASS, ""))
    ...
    def login(self) -> bool:
        ...
        if not self._api_key and not self._password:
            raise ValueError(
                f"Missing credentials: set {_ENV_API_KEY} or {_ENV_PASSWORD}"
            )
