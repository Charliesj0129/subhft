...
def test_adapter_no_duplicate_methods():
    from hft_platform.feed_adapter.adapter import FeedAdapter
    # Inspect class dict?
    # Python resolves to one method at runtime.
    # This test just ensures we can import it and instantiate without syntax error.
    # And that calling _monitor_loop exists.
    assert hasattr(FeedAdapter, "_monitor_loop")
