...
import pytest
from hft_platform.cli._health import _check_checkpoint_recent, _check_disk_space, _check_kill_switch, _check_wal_backlog, _check_config_valid, cmd_health_preflight
...
class TestCheckCheckpointRecent:
    ...
    def test_recent(self, tmp_path, monkeypatch):
        p = tmp_path / "cp.json"; p.write_text("{}")
