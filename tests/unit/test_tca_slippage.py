...
class TestSlippageDecomposer:
    ...
    def test_zero_slippage_when_prices_equal(self) -> None:
        result = self.decomposer.decompose(
            decision_price=200_000_000, arrival_price=200_000_000,
            fill_price=200_000_000, notional_ntd=200_000, fee_ntd=13, tax_ntd=0,
        )
    ...
    def test_delay_cost_captured(self) -> None:
        result = self.decomposer.decompose(
            decision_price=200_000_000, arrival_price=200_010_000,
            fill_price=200_010_000, notional_ntd=200_000, fee_ntd=13, tax_ntd=0,
        )
    ...
    def test_execution_cost_captured(self) -> None:
        result = self.decomposer.decompose(
            decision_price=200_000_000, arrival_price=200_000_000,
            fill_price=200_020_000, notional_ntd=200_000, fee_ntd=13, tax_ntd=0,
        )
    ...
    def test_total_is_sum_of_components(self) -> None:
        result = self.decomposer.decompose(
            decision_price=200_000_000, arrival_price=200_010_000,
            fill_price=200_030_000, notional_ntd=200_000, fee_ntd=13, tax_ntd=6,
        )
        expected_total = (
    ...
    def test_zero_notional_returns_zero_breakdown(self) -> None:
        result = self.decomposer.decompose(
            decision_price=200_000_000, arrival_price=200_000_000,
            fill_price=200_000_000, notional_ntd=0, fee_ntd=0, tax_ntd=0,
        )
