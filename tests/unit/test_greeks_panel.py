...
def test_snapshot_from_dict():
    ...
    data = {"ts": 1000000000, "net_delta_lots": 12.3, "net_gamma_lots": 3.1,
        "net_theta_ntd": -45200.0, "net_vega_ntd": 82000.0,
        "worst_pnl_ntd": -156000.0, "eye_state": "QUOTING"}
...
def test_render_greeks_panel():
    ...
    snap = PortfolioGreeksSnapshot(ts=1000000000, net_delta_lots=12.3, net_gamma_lots=3.1,
        net_theta_ntd=-45200.0, net_vega_ntd=82000.0, worst_pnl_ntd=-156000.0, eye_state="QUOTING")
