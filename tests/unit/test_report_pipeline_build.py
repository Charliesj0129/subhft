...
- test_default_symbol_is_txfc0: collector.collect called with "TXFC0"
"""
...
class TestBuildReport:
    ...
    def test_default_symbol_is_txfc0(self, mock_session_data, mock_fact_report, mock_reasoning_report):
        """build_report passes 'TXFC0' as the default symbol to collector.collect."""
        mock_collector = MagicMock()
        mock_collector.collect.return_value = mock_session_data
        mock_collector.collect_cross_day.return_value = []
        ...
        mock_collector.collect.assert_called_once_with("day", "2026-03-28", "TXFC0")
