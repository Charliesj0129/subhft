...
def test_extract_market_data_values_length_matches_columns():
    ...
    row = {
        "symbol": "TXFC0", "exchange": "TAIFEX", "type": "Tick",
        "exch_ts": 1000000000, "ingest_ts": 1000000001,
        "price_scaled": 220000000, "volume": 1,
        "bids_price": [], "bids_vol": [], "asks_price": [], "asks_vol": [],
        "seq_no": 1,
        "instrument_type": "future", "underlying": "TX",
        "strike_scaled": 0, "option_right": "", "expiry": "1970-01-01",
    }
