...
from hft_platform.contracts.strategy import OrderIntent, IntentType, Side, TIF, RiskDecision
...
class TestBacktestSimToReal(unittest.TestCase):
    ...
    def test_risk_and_lob_integration(self, MockRegistry, MockLOB, MockRisk):
        ...
        mock_strat.on_book.return_value = [
            OrderIntent(strategy_id="test_strat", symbol="2330", side=Side.BUY, price=100.0, qty=1, intent_type=IntentType.NEW, intent_id="1")
        ]
