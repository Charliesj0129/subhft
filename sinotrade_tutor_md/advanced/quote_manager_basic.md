...
the whole project code can be found in [sj-trading](https://github.com/Sinotrade/sj-trading-demo),
the whole example jupyter notebook can be found in [quote\_manager\_usage](https://github.com/Sinotrade/sj-trading-demo/blob/main/quote_manager_usage.ipynb).
...
polars\_talib is a Polars extension package that provides the complete functionality of the ta-lib library in the polars expression version, allowing us to easily calculate technical indicators using Polars. It is developed by the shioaji author, and detailed usage can be found in [polars\_ta\_extension](https://github.com/Yvictor/polars_ta_extension).
...
![df_stk](/img/quote_manager1.png#center)
...
The complete example jupyter notebook can be found in [quote\_manager\_usage](https://github.com/Sinotrade/sj-trading-demo/blob/main/quote_manager_usage.ipynb).
