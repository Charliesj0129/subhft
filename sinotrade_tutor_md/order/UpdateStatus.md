...
### Get Stock Trades[¶](#get-stock-trades "Permanent link")
...
### Get Futures Trades[¶](#get-futures-trades "Permanent link")
...
### Update Specific Trade[¶](#update-specific-trade "Permanent link")
...
### Trade Status[¶](#trade-status "Permanent link")
