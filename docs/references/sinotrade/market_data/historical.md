...
### By Date[¶](#by-date "Permanent link")
...
| ts | ask\_price | close | bid\_volume | volume | ask\_volume | tick\_type | bid\_price |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
### Range Time[¶](#range-time "Permanent link")
...
### Last Count[¶](#last-count "Permanent link")
...
## Historical Periods[¶](#historical-periods "Permanent link")
...
## Continuous Futures[¶](#continuous-futures "Permanent link")
