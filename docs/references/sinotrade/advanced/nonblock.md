...
### Non-Blocking Place Order[¶](#non-blocking-place-order "Permanent link")
...
#### Order event callback[¶](#order-event-callback "Permanent link")
...
#### Non-blocking place order callback[¶](#non-blocking-place-order-callback "Permanent link")
...
### Compare both modes[¶](#compare-both-modes "Permanent link")
