...
## Sign Documents[¶](#sign-documents "Permanent link")
...
![signature](https://raw.githubusercontent.com/Sinotrade/Sinotrade.github.io/master/img/signature.png)

## Test Report[¶](#test-report "Permanent link")
...
### Version Check[¶](#version-check "Permanent link")
...
### Login Test[¶](#login-test "Permanent link")
...
### Place Order Test - Stock[¶](#place-order-test-stock "Permanent link")
...
* You should receive the message, `Response Code: 0 | Event Code: 0 | Info: host '218.32.76.102:80' ...`, which means that you have successfully connected to our testing server. The message will only appear on your first order. If you don't receive the connected message, please confirm that all the following conditions are met.
  ...
  2. Version restriction
  3. `signed` is not present in your account
...
### Place Order Test - Futures[¶](#place-order-test-futures "Permanent link")

Future Order

verion>=1.0verion<1.0
...
### Check if API tests has passed[¶](#check-if-api-tests-has-passed "Permanent link")
...
## CA[¶](#ca "Permanent link")

You must **apply** and **activate** the CA before `place_order`.

### Apply CA[¶](#apply-ca "Permanent link")

1. Go to [SinoPac Securities](https://www.sinotrade.com.tw/CSCenter/CSCenter_13_3) to download eleader
   ![eleader_download](https://raw.githubusercontent.com/Sinotrade/Sinotrade.github.io/master/img/eleader_download.png)
2. Login eleader

   ![login eleader](https://raw.githubusercontent.com/Sinotrade/Sinotrade.github.io/master/img/eleader.png)
3. Select (3303)帳號資料設定 from the 帳戶資料 above
   ![eleader_account](https://raw.githubusercontent.com/Sinotrade/Sinotrade.github.io/master/img/eleader_account.png)
4. Click "步驟說明"
   ![CA_step](https://raw.githubusercontent.com/Sinotrade/Sinotrade.github.io/master/img/CA_step.png)
5. CA Operation steps
   ![CA_info](https://raw.githubusercontent.com/Sinotrade/Sinotrade.github.io/master/img/CA_info.png)

### Activate CA[¶](#activate-ca "Permanent link")
...
#### Check CA expire time[¶](#check-ca-expire-time "Permanent link")
