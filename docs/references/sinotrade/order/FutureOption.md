...
### Futures Order[¶](#futures-order "Permanent link")
...
### Update Order[¶](#update-order "Permanent link")
...
#### Update Quantity (Reduce)[¶](#update-quantity-reduce "Permanent link")
...
### ROD + LMT[¶](#rod-lmt "Permanent link")
