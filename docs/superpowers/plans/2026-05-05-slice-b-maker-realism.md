...
## 9. Post-review delta (filled in after Codex pass)

> _To be appended after Codex review. Mirror Slice C plan's §9 structure: ACCEPT-WITH-FIXES; list applied edits with file:line; final verdict._
