...
| CE3-03 | Scale out WAL loader workers and shard assignment policy | P1 | 3d | CE3-02 | TBD | ✅ Implemented |
| CE3-04 | Define replay safety contract (ordering + dedup + manifest) | P0 | 3d | CE3-02 | TBD | ✅ Implemented |
| CE3-06 | Add WAL SLO metrics, alerts, and dashboards | P1 | 2d | CE3-02, CE3-05 | TBD | ✅ Implemented |
| CE3-07 | Outage drills: ClickHouse down, slow, and WAL growth recovery | P0 | 3d | CE3-03, CE3-04, CE3-05 | TBD | ✅ Implemented |
...
- [✅] [CE3-03] `FileClaimRegistry` + parallel loader processing (`recorder/shard_claim.py`, `recorder/loader.py`) + `tests/integration/test_wal_loader_scale_out.py`
- [✅] [CE3-04] `ReplayContract` + strict-order/dedup/manifest restart safety tests (`recorder/replay_contract.py`, `tests/spec/test_replay_safety_contract.py`)
