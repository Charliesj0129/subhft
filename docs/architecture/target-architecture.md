...
| ------------------------------------------ | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| D1: Canonical runtime schema               | Resolved           | Recorder writer/loader leverages sequential runner from `src/hft_platform/migrations/clickhouse/` via `recorder/schema.py`                                         | Centralized DDL into a migration runner and removed legacy SQL files to remove ambiguity.                                                                    |
...
- [x] CE2-07: Metrics/SLOs — `gateway_dispatch_latency_ns`, `gateway_reject_total`, `gateway_dedup_hits_total` dashboards
...
- [x] CE2-11: `quote_version=v1` schema guard with reject-and-alert on mismatch
...
- [x] CE3-03: Scale-out WAL loader workers with shard-claim protocol integration tests
- [x] CE3-04: Full replay safety contract (ordering + dedup + manifest) tested under restart/crash scenarios
- [x] CE3-06: WAL SLO metrics — backlog size, replay lag, replay throughput, drain ETA
