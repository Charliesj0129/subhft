...
```json
{
  ...
  "hypothesis": "Fast L1 bid replenishment after depletion signals committed passive buyers and precedes upward mid drift.",
  "features": [
    {
      "name": "rep_bid",
      "formula": "ema(depth_delta('bid', 1, '200ms'), '2s')"
    }
  ],
  ...
  "falsification_tests": [
    "Signal std collapses to zero on quiet days"
  ]
}
```
