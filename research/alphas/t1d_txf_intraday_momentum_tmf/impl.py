"""Governed artifact marker for T1-D V0 viability research.
...
live strategy wiring.  T1-D is not promotion-eligible until Gate C emits a
...
ALPHA_ID = "t1d_txf_intraday_momentum_tmf"
