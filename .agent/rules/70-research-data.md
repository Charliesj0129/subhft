...
Local corpus now spans 2026-01-26 to 2026-07-25 (877,326,445 rows) after the 2026-07-25 pull from the production host; its TTL was removed locally. Coverage holes, degraded days, and the 368 -> 296 symbol-universe change are inventoried in `docs/operations/local-clickhouse-market-data-corpus.md` — read it before choosing a date range.
